...
class UpdateVideoDurationRule implements Rule
{
    /**
    ...
    {
        return $this->challenge->isAbleToChangeVideoDuration() || ((int) $value === $this->challenge->getRequiredVideoDuration());
    }
    ...
    {
        return 'The challenge already has proofs';
    }
}