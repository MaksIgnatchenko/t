            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <p>
                        ...
                        {!! Form::select('country', $dto->getCountries(), $dto->getCurrentCountry(), ['placeholder' => 'Select country', 'class' => 'form-control']) !!}
                    </p>
        ...
        <div class="box">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('proof_type', $dto->getProofTypes(), $dto->getCurrentProofType(), ['class' => 'form-control', 'placeholder' => 'Select proof type']) !!}
        ...
        <div class="box">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    {!! Form::text('items_count_in_proof', $dto->getCurrentItemsCount(), ['class' => 'form-control']) !!}
        ...
        <div class="box">
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('video_duration', $dto->getVideoLengthTypes(), $dto->getCurrentVideoDuration(),  ['class' => 'form-control', 'placeholder' => 'Select video duration']) !!}
        ...
        <div class="box">
            <div class="box-body">
                ...
                <div class="form-group" hidden>
                    {!! Form::text('image', $dto->getCurrentImageName(), ['class' => 'form-control']) !!}
                </div>
...
<div class="row form-justify-container">
    <div class="col-md-12">
        ...
        {!! Form::textarea('description', $dto->getCurrentDescription(), ['class' => 'form-control', 'maxlength' => 1000]) !!}
